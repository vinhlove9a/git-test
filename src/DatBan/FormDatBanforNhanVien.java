 ...
 * @author Admin
 */
public class FormDatBanforNhanVien extends javax.swing.JFrame {

    /**
     * Creates new form ViewDatBan
     */
    public FormDatBanforNhanVien() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/icon/food_25px.png"))); // NOI18N
        jButton17.setText("Quản lý sản phẩm");
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton17, jButton3, jButton4, jButton5, jButton6, jButton7, jButton8});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDatBanforNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDatBanforNhanVien().setVisible(true);
            }
        });
    }
