 ...
 * @author Admin
 */
public class FormAllChucNang extends javax.swing.JFrame {

    /**
     * Creates new form FormChucNang
     */
    public FormAllChucNang() {
        initComponents();
        // showPieChart();
        showLineChart();
        showHistogram();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAllChucNang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAllChucNang().setVisible(true);
            }
        });
    }
