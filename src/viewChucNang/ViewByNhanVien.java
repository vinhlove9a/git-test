...
import QuanLySanPham.FormQLSPforNhanVien;
 ...
 * @author Admin
 */
public class ViewByNhanVien extends javax.swing.JFrame {

    /**
     * Creates new form FormChucNang
     */
    public ViewByNhanVien() {
        initComponents();
        // showPieChart();
        showLineChart();
        showHistogram();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewByNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewByNhanVien().setVisible(true);
            }
        });
    }
